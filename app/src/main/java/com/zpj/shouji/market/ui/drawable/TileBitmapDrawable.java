//package com.zpj.shouji.market.ui.drawable;
//
...
//        final int levelCount = Math.max(1, MathUtil.ceilLog2(mIntrinsicWidth / (mIntrinsicWidth * minScale)));
//
//        // sampleSize = 2 ^ currentLevel
//        final int currentLevel = MathUtil.clamp(MathUtil.floorLog2(1 / scale), 0, levelCount - 1);
...
//                if (null == bitmap) {
//                    //下载的图片有问题,将其删掉
//                    FileUtil.deleteFiles((String) params[0]);
