...
//
//    private List<AppChinaItem> appChinaItemList;
...
//            app_update_time = view.findViewById(R.id.app_update_time);
//            app_introduce = view.findViewById(R.id.app_introduce);
