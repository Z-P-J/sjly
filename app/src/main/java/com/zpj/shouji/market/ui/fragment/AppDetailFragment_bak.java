...
//
//    public static AppDetailFragment_bak newInstance(String site) {
...
//    }
//
//    public static AppDetailFragment_bak newInstance(String type, String id) {
//        String site;
//        if ("game".equals(type)) {
...
//    }
//
//    public static AppDetailFragment_bak newInstance(AppItem item) {
//        return newInstance(item.getAppType(), item.getAppId());
//    }
//
//    public static AppDetailFragment_bak newInstance(AppUpdateInfo item) {
//        return newInstance(item.getAppType(), item.getId());
//    }
//
//    public static AppDetailFragment_bak newInstance(InstalledAppInfo appInfo) {
//        return newInstance(appInfo.getAppType(), appInfo.getId());
//    }
//
//    public static AppDetailFragment_bak newInstance(UserDownloadedAppInfo info) {
