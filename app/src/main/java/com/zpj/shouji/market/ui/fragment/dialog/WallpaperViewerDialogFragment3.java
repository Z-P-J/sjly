...
//    }
    ...
    public WallpaperViewerDialogFragment3 setWallpaperInfo(WallpaperInfo wallpaperInfo) {
        this.wallpaperInfo = wallpaperInfo;
        return this;
    }

    public WallpaperViewerDialogFragment3 setOriginalImageList(List<String> originalImageList) {
