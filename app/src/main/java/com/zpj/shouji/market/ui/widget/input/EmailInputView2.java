 ...
 */
public class EmailInputView2 extends InputView2 {

    private ImageView mIvAccountIcon;
    private ImageView mIvDeleteIcon;

    public EmailInputView2(Context context) {
        super(context);
    }

    public EmailInputView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public EmailInputView2(Context context, AttributeSet attrs, int defStyleAttr) {
