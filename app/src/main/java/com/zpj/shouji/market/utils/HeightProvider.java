...
public class HeightProvider extends PopupWindow {
     ...
     */
    public HeightProvider(Activity activity, final long delayMillis) {
        super(activity);
        this.activity = activity;

        LayoutInflater inflater = (LayoutInflater) activity.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        this.popupView = inflater.inflate(com.zpj.utils.R.layout.layout_popup_window_keyboard, null, false);
