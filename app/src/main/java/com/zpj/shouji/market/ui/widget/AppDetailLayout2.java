 ...
 * @author hufeiyang
 */
public class AppDetailLayout2 extends FrameLayout {
    ...
    public AppDetailLayout2(Context context) {
        this(context, null);
    }

    public AppDetailLayout2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AppDetailLayout2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
