...
public class AppDetailRecommendFragment2 extends SkinFragment {
    ...
    public static AppDetailRecommendFragment2 newInstance(String id, String type) {
        Bundle args = new Bundle();
        args.putString(Keys.ID, id);
        args.putString(Keys.TYPE, type);
        AppDetailRecommendFragment2 fragment = new AppDetailRecommendFragment2();
