...
//
//public class DownloadManagerFragment_bak extends BaseSwipeBackFragment
//        implements DownloadManager.DownloadManagerListener,
//        GroupRecyclerViewAdapter.OnItemClickListener<DownloadManagerFragment_bak.DownloadWrapper> {
//
...
//
//    public static DownloadManagerFragment_bak newInstance(boolean showToolbar) {
//        Bundle args = new Bundle();
//        args.putBoolean(Keys.SHOW_TOOLBAR, showToolbar);
//        DownloadManagerFragment_bak fragment = new DownloadManagerFragment_bak();
//        fragment.setArguments(args);
//        return fragment;
//    }
//
//    public static void start(boolean showToolbar) {
//        start(DownloadManagerFragment_bak.newInstance(showToolbar));
//    }
//
//    @Override
...
//            holder.setImageResource(R.id.iv_arrow, isExpand(groupPosition) ? R.drawable.ic_keyboard_arrow_down_black_24dp : R.drawable.ic_keyboard_arrow_right_black_24dp);
//            if (groupPosition == 0) {
