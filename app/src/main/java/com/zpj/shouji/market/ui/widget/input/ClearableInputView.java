 ...
 */
public class ClearableInputView extends InputView {
    ...
    public ClearableInputView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ClearableInputView(Context context, AttributeSet attrs, int defStyleAttr) {
