...
//
//public class CommonImageViewerPopup2 extends ImageViewerPopup<String>
...
//
//    public static CommonImageViewerPopup2 with(@NonNull Context context) {
//        return new CommonImageViewerPopup2(context);
//    }
//
//    private CommonImageViewerPopup2(@NonNull Context context) {
//        super(context);
...
////                .apply(
////                        RequestOptions
////                                .bitmapTransform(new CompressTransformation())
...
//    }
//
//    public CommonImageViewerPopup2 setOriginalImageList(List<String> originalImageList) {
//        this.originalImageList = originalImageList;
//        return this;
//    }
//
//    public CommonImageViewerPopup2 setImageSizeList(List<String> imageSizeList) {
