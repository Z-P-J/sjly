 ...
 */
package com.zpj.imagepicker.model;
...
import com.zpj.imagepicker.ui.widget.CheckView;
import com.zpj.imagepicker.utils.PathUtils;
import com.zpj.imagepicker.utils.PhotoMetadataUtils;
...
//    private final Context mContext;
    ...
    public String isAcceptable(Context context, Item item) {
        if (maxSelectableReached()) {
            ...
            return context.getString(R.string.error_type_conflict);
        }
