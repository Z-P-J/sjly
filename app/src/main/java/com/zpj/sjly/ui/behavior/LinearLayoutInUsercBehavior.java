package com.zpj.sjly.ui.behavior;
...
import com.zpj.sjly.ui.widget.DisInterceptNestedScrollView;
 ...
 */
public class LinearLayoutInUsercBehavior extends CoordinatorLayout.Behavior<LinearLayout> {
    ...
    public LinearLayoutInUsercBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
     ...
     * @param dependency
     */
    private void init(CoordinatorLayout parent, LinearLayout child, View dependency) {
        if (mStartAvatarY == 0) {
