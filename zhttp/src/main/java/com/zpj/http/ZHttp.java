...
public class ZHttp {
     ...
     * Use examples:
     * <ul>
     *  <li><code>Document doc = ZHttp.connect("http://example.com").userAgent("Mozilla").data("name", "jsoup").get();</code></li>
    ...
    public static Connection get(String url) {
        return connect(url).method(Connection.Method.GET);
    }

    public static Connection post(String url) {
        return connect(url).method(Connection.Method.POST);
    }

    public static Connection head(String url) {
        return connect(url).method(Connection.Method.HEAD);
    }

    public static Connection put(String url) {
        return connect(url).method(Connection.Method.PUT);
    }

    public static Connection delete(String url) {
        return connect(url).method(Connection.Method.DELETE);
    }

    public static Connection patch(String url) {
        return connect(url).method(Connection.Method.PATCH);
    }

    public static Connection options(String url) {
        return connect(url).method(Connection.Method.OPTIONS);
    }

    public static Connection trace(String url) {
        return connect(url).method(Connection.Method.TRACE);
    }
