...
// * <p><code>java -cp jsoup.jar com.zpj.http.examples.HtmlToPlainText url [selector]</code></p>
...
//        Validate.isTrue(args.length == 1 || args.length == 2, "usage: java -cp jsoup.jar com.zpj.http.examples.HtmlToPlainText url [selector]");
//        final String url = args[0];
//        final String selector = args.length == 2 ? args[1] : null;
//
//        // fetch the specified URL and parse to a HTML DOM
//        Document doc = ZHttp.connect(url).userAgent(userAgent).timeout(timeout).get();
//
