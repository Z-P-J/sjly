...
public class CenterSelectPopup<T> extends CenterPopup<CenterSelectPopup<T>> {
...
//    private int itemRes;
    ...
    public CenterSelectPopup(@NonNull Context context) {
        super(context);
    }
    ...
    public CenterSelectPopup<T> setTitle(String title) {
        this.title = title;
        return this;
    }

    public CenterSelectPopup<T> setData(List<T> list) {
        this.list.addAll(list);
        return this;
    }

    public CenterSelectPopup<T> setMultiple(boolean isMultiple) {
        this.isMultiple = isMultiple;
        return this;
    }

    public CenterSelectPopup<T> setSelected(int[] selected) {
    ...
    public CenterSelectPopup<T> setOnSingleSelectListener(OnSingleSelectListener<T> onSingleSelectListener) {
        this.onSingleSelectListener = onSingleSelectListener;
        return this;
    }

    public CenterSelectPopup<T> setOnMultiSelectListener(OnMultiSelectListener<T> onMultiSelectListener) {
        this.onMultiSelectListener = onMultiSelectListener;
        return this;
    }

    public CenterSelectPopup<T> setIconCallback(IconCallback<T> iconCallback) {
        this.iconCallback = iconCallback;
        return this;
    }

    public CenterSelectPopup<T> setTitleCallback(TitleCallback<T> titleCallback) {
        this.titleCallback = titleCallback;
        return this;
    }

    public CenterSelectPopup<T> setSubtitleCallback(SubtitleCallback<T> subtitleCallback) {
