...
public abstract class BasePopup extends FrameLayout implements OnNavigationBarListener {
    ...
    public BasePopup setPopupAnimator(PopupAnimator animator) {
    ...
    public BasePopup setOnBackPressedListener(OnBackPressedListener onBackPressedListener) {
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_UP) {
                if (popupInfo.isDismissOnBackPressed &&
                        ...
                        (onBackPressedListener == null || !onBackPressedListener.onBackPressed())) {
