...
public class CardRelativeLayout extends RelativeLayout {
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate() {
        ...
        public boolean getUseCompatPadding() {
            return CardRelativeLayout.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return CardRelativeLayout.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            CardRelativeLayout.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                CardRelativeLayout.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                CardRelativeLayout.super.setMinimumHeight(height);
            }
        }
        ...
        public View getCardView() {
            return CardRelativeLayout.this;
        }
    };

    public CardRelativeLayout(@NonNull Context context) {
        this(context, null);
    }

    public CardRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
