...
import com.zpj.matisse.loader.AlbumMediaLoader;

import java.lang.ref.WeakReference;

public class AlbumMediaManager implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return AlbumMediaLoader.newInstance(context, album, false);
    }
