...
public class RoundRelativeLayout extends RelativeLayout {
    ...
    public RoundRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            float radius = ta.getDimension(R.styleable.RoundRelativeLayout_round_radius, 0);

            topLeftRadius = ta.getDimension(R.styleable.RoundRelativeLayout_round_topLeftRadius, radius);

            topRightRadius = ta.getDimension(R.styleable.RoundRelativeLayout_round_topRightRadius, radius);

            bottomLeftRadius = ta.getDimension(R.styleable.RoundRelativeLayout_round_bottomLeftRadius, radius);

            bottomRightRadius = ta.getDimension(R.styleable.RoundRelativeLayout_round_bottomRightRadius, radius);
