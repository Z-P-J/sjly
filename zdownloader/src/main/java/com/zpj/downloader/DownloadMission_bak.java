...
// */
//@Keep
//public class DownloadMission_bak extends BaseConfig<DownloadMission_bak> {
//    private static final String TAG = DownloadMission_bak.class.getSimpleName();
//
...
//        if (blockQueue == null) {
//            synchronized (DownloadMission_bak.class) {
//                if (blockQueue == null) {
...
//                        if (handleResponse(res, DownloadMission_bak.this)) {
...
//                            name = getMissionNameFromUrl(DownloadMission_bak.this, url);
//                        }
//
//                        Log.d("mission.name", "mission.name555=" + name);
//
//                        for (DownloadMission_bak downloadMission : DownloadManagerImpl.getInstance().getMissions()) {
...
//                getNotificationInterceptor().onProgress(getContext(), DownloadMission_bak.this, getProgress(), false);
//            }
//        }
//    };
//
//    protected DownloadMission_bak() {
//
//    }
//
//    //-------------------------下载任务状态-----------------------------------
...
//    }
//
//    public synchronized DownloadMission_bak addListener(MissionListener listener) {
...
//                        String json = getGson().toJson(DownloadMission_bak.this);
...
//    }
//
//    private boolean handleResponse(Connection.Response response, DownloadMission_bak mission) {
...
//    }
//
//    protected String getMissionNameFromUrl(DownloadMission_bak mission, String url) {
...
//    }
//
//    private boolean checkLength(DownloadMission_bak mission) {
//        if (mission.length <= 0) {
