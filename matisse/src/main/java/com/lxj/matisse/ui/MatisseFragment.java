...
// */
//public class MatisseFragment extends AppCompatActivity implements
...
//                Intent intent = new Intent(MatisseFragment.this, CameraActivity.class);
//                startActivityForResult(intent, MatisseConst.REQUEST_CODE_CAPTURE);
//            }
//
//            @Override
//            public void onDenied() {
//                Toast.makeText(MatisseFragment.this, "没有权限，无法使用该功能", Toast.LENGTH_SHORT).show();
//            }
//        }).request();
//    }
//
