 ...
 */
public class ZAlertDialog_bak implements IDialog {
    ...
    private ZAlertDialog_bak(Context context) {
        this.context = context;
        dialog = ZDialog.with(context);
    }

    public static ZAlertDialog_bak with(Context context) {
        return new ZAlertDialog_bak(context);
    }

    public ZAlertDialog_bak setTitle(String title) {
        this.title = title;
        return this;
    }

    public ZAlertDialog_bak setTitle(@StringRes int title) {
        this.title = context.getResources().getString(title);
        return this;
    }

    public ZAlertDialog_bak setTitleTextColor(@ColorInt int titleTextColor) {
        this.titleTextColor = titleTextColor;
        return this;
    }

    public ZAlertDialog_bak setContentView(View contentView) {
        this.contentView = contentView;
        return this;
    }

    public ZAlertDialog_bak setContentView(@LayoutRes int resId) {
        this.contentView = LayoutInflater.from(context).inflate(resId, null);
        return this;
    }

    public ZAlertDialog_bak setGravity(int gravity) {
        dialog.setGravity(gravity);
        return this;
    }

    public ZAlertDialog_bak setAnimatorCreateListener(DialogFragment.OnAnimatorCreateListener onAnimatorCreateListener) {
        dialog.setAnimatorCreateListener(onAnimatorCreateListener);
        return this;
    }

    public ZAlertDialog_bak setOnViewCreateListener(OnViewCreateListener listener) {
        this.onViewCreateListener = listener;
        return this;
    }

    public ZAlertDialog_bak setContent(CharSequence content) {
        return setContent(content, Color.parseColor("#525a66"));
    }

    public ZAlertDialog_bak setContent(CharSequence content, @ColorInt int textColor) {
    ...
    public ZAlertDialog_bak setContent(@StringRes int content) {
        return setContent(context.getResources().getString(content));
    }

    public ZAlertDialog_bak setContent(@StringRes int content, @ColorInt int textColor) {
        return setContent(context.getResources().getString(content), textColor);
    }

    public ZAlertDialog_bak setScreenWidthP(float percentage) {
        screenWidthPercent = percentage;
        return this;
    }

    public ZAlertDialog_bak setSwipable(boolean swipable) {
        this.swipable = swipable;
        return this;
    }

    public ZAlertDialog_bak setCancelable(boolean cancelable) {
        isCancelable = cancelable;
        return this;
    }

    public ZAlertDialog_bak setCancelableOutside(boolean cancelableOutside) {
        isCancelableOutside = cancelableOutside;
        return this;
    }

    public ZAlertDialog_bak setPositiveButton(OnClickListener onclickListener) {
        return setPositiveButton("确定", onclickListener);
    }

    public ZAlertDialog_bak setPositiveButton(String btnStr, OnClickListener onclickListener) {
        this.positiveBtnStr = btnStr;
        this.positiveBtnListener = onclickListener;
        return this;
    }

    public ZAlertDialog_bak setPositiveButtonTextColor(@ColorInt int textColor) {
        this.positiveBtnTextColor = textColor;
        return this;
    }

    public ZAlertDialog_bak setPositiveButton(@StringRes int strRes, OnClickListener onclickListener) {
        return setPositiveButton(context.getResources().getString(strRes), onclickListener);
    }

    public ZAlertDialog_bak setNegativeButton(OnClickListener onclickListener) {
        return setNegativeButton("取消", onclickListener);
    }

    public ZAlertDialog_bak setNegativeButton(String btnStr, OnClickListener onclickListener) {
        this.negativBtnStr = btnStr;
        this.negativeBtnListener = onclickListener;
        return this;
    }

    public ZAlertDialog_bak setNegativeButton(@StringRes int strRes, OnClickListener onclickListener) {
        return setNegativeButton(context.getResources().getString(strRes), onclickListener);
    }

    public ZAlertDialog_bak setNegativeButtonTextColor(@ColorInt int textColor) {
        this.negativeBtnTextColor = textColor;
        return this;
    }

    public ZAlertDialog_bak setOnDismissListener(OnDismissListener onDismissListener) {
        this.onDismissListener = onDismissListener;
        return this;
    }

    public ZAlertDialog_bak setOnCancelListener(OnCancelListener onCancelListener) {
        this.onCancelListener = onCancelListener;
        return this;
    }

    @Override
    public ZAlertDialog_bak show() {
