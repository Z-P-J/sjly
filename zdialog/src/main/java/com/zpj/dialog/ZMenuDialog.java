...
//
//                            if (locationX > ScreenUtils.getScreenWidth(zDialog.getActivity()) / 2) {
//                                window.setGravity(Gravity.END | Gravity.TOP);
//                                lp.x = ScreenUtils.getScreenWidth(zDialog.getActivity()) - locationX;
//                            } else {
...
//                            if (locationY + windowHeight > ScreenUtils.getScreenHeight(zDialog.getActivity())) {
