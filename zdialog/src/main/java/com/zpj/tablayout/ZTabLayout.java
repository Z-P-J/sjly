 ...
 *
 * <p>You can also add items to TabLayout in your layout through the use of {@link ZTabItem}.
 ...
 *             android:text=&quot;@string/z_layout_tab_text&quot;/&gt;
 *
 *     &lt;android.support.design.widget.TabItem
 ...
 *
 * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabPadding
 * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabPaddingStart
 * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabPaddingTop
 * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabPaddingEnd
 * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabPaddingBottom
 * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabContentStart
 * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabBackground
 * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabMinWidth
 * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabMaxWidth
 * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabTextAppearance
 */
@ViewPager.DecorView
public class ZTabLayout extends LinearLayout {
...
//                LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT));
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ZTabLayout,
                defStyleAttr, R.style.ZTabLayout_Default_Style);

//        mTabStrip.setSelectedIndicatorHeight(
//                a.getDimensionPixelSize(R.styleable.ZTabLayout_z_tabIndicatorHeight, 0));
////        mTabStrip.setSelectedIndicatorWidth(
////                a.getDimensionPixelSize(R.styleable.ZTabLayout_z_tabIndicatorWidth, 0));
//        mTabStrip.setSelectedIndicatorColor(a.getColor(R.styleable.ZTabLayout_z_tabIndicatorColor, 0));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(R.styleable.ZTabLayout_z_tabPadding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.ZTabLayout_z_tabPaddingStart,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.ZTabLayout_z_tabPaddingTop,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.ZTabLayout_z_tabPaddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.ZTabLayout_z_tabPaddingBottom,
                mTabPaddingBottom);

        mTabTextAppearance = a.getResourceId(R.styleable.ZTabLayout_z_tabTextAppearance,
                R.style.TabText);

        mEnableScale = a.getBoolean(R.styleable.ZTabLayout_z_enableScale, false);
        ...
        if (a.hasValue(R.styleable.ZTabLayout_z_tabTextColor)) {
            // If we have an explicit text color set, use it instead
            mTabTextColors = a.getColorStateList(R.styleable.ZTabLayout_z_tabTextColor);
        }

        if (a.hasValue(R.styleable.ZTabLayout_z_tabSelectedTextColor)) {
            // We have an explicit selected text color set, so we need to make merge it with the
            // current colors. This is exposed so that developers can use theme attributes to set
            // this (theme attrs in ColorStateLists are Lollipop+)
            final int selected = a.getColor(R.styleable.ZTabLayout_z_tabSelectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.ZTabLayout_z_tabMinWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.ZTabLayout_z_tabMaxWidth,
                INVALID_WIDTH);
        mTabBackgroundResId = a.getResourceId(R.styleable.ZTabLayout_z_tabBackground, 0);
        mContentInsetStart = a.getDimensionPixelSize(R.styleable.ZTabLayout_z_tabContentStart, 0);
        mMode = a.getInt(R.styleable.ZTabLayout_z_tabMode, MODE_FIXED);
        mTabGravity = a.getInt(R.styleable.ZTabLayout_z_tabGravity, GRAVITY_FILL);
        a.recycle();

        // TODO add attr for these
        final Resources res = getResources();
        mTabTextMultiLineSize = res.getDimensionPixelSize(R.dimen.z_tab_text_size_2line);
        mScrollableTabMinWidth = res.getDimensionPixelSize(R.dimen.z_tab_scrollable_min_width);
     ...
     *
     * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabIndicatorColor
     */
...
//        mTabStrip.setSelectedIndicatorColor(color);
     ...
     *
     * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabIndicatorHeight
     */
...
//        }
        ...
        if (mEnableScale && positionOffset >= 0) {
            Tab leftTab = getTabAt(position);
            Tab rightTab = getTabAt(position + 1);
            Log.d(TAG, "");
            if (leftTab != null && rightTab != null) {
                View left = leftTab.getTabView().getTextView();
                View right = rightTab.getTabView().getTextView();
...
//                    right.setScaleX(MAX_SCALE - (MAX_SCALE - 1.0f) * positionOffset);
//                    right.setScaleY(MAX_SCALE - (MAX_SCALE - 1.0f) * positionOffset);
//                    left.setScaleX(1.0f + (MAX_SCALE - 1.0f) * positionOffset);
//                    left.setScaleY(1.0f + (MAX_SCALE - 1.0f) * positionOffset);
...
//    }
    ...
    public void addTab(@NonNull Tab tab, int position, boolean setSelected) {
        ...
        Log.d(TAG, "addTab addTab addTab setSelected=" + setSelected);
        if (setSelected) {
            tab.select();
        }
    }

    private void addTabFromItemView(@NonNull ZTabItem item) {
     ...
     *
     * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabMode
     */
     ...
     *
     * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabGravity
     */
     ...
     * Sets the text colors for the different states (normal, selected) used for the tabs.
     *
     * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabTextColor
     * @attr ref android.support.design.R.styleable#ZTabLayout_z_tabSelectedTextColor
     */
    ...
    void populateFromPagerAdapter() {
        ...
        if (mPagerAdapter != null) {
            ...
            for (int i = 0; i < adapterCount; i++) {
                ...
                addTab(tab, false);
//                if (mEnableScale) {
//                    tab.getTabView().getTextView().setScaleX(MAX_SCALE);
//                    tab.getTabView().getTextView().setScaleY(MAX_SCALE);
//                }
            }
            ...
            if (mViewPager != null && adapterCount > 0) {
                ...
                if (curItem != getSelectedTabPosition() && curItem < getTabCount()) {
                    Tab tab = getTabAt(curItem);
//                    if (tab != null && mEnableScale) {
//                        tab.getTabView().getTextView().setScaleX(1f);
//                        tab.getTabView().getTextView().setScaleY(1f);
//                    }
                    selectTab(tab);
                }
            }
...
//        mTabStrip.animateIndicatorToPosition(newPosition, ANIMATION_DURATION);
    ...
    private void applyModeAndGravity() {
        ...
        Log.d(TAG, "applyModeAndGravity paddingStart=" + paddingStart);
            ...
            if (mCustomView == null) {
                ...
                if (mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext())
                            .inflate(R.layout.z_layout_tab_icon, this, false);
                ...
                if (mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext())
                            .inflate(R.layout.z_layout_tab_text, this, false);
...
//            }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public TabLayoutOnPageChangeListener(ZTabLayout ZTabLayout) {
            mTabLayoutRef = new WeakReference<>(ZTabLayout);
        }
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final ZTabLayout ZTabLayout = mTabLayoutRef.get();
            if (ZTabLayout != null) {
                ...
                ZTabLayout.setScrollPosition(position, positionOffset, updateText, updateIndicator);
            }
//            if (ZTabLayout == null) {
//                return;
//            }
...
//                ZTabLayout.mTabStrip.left = ZTabLayout.mTabStrip.getChildAt(position).getLeft()
//                        + scale * ZTabLayout.mTabStrip.getChildAt(position).getWidth();
//                float lr = ZTabLayout.mTabStrip.getChildAt(position).getRight()
//                        - scale * ZTabLayout.mTabStrip.getChildAt(position).getWidth();
//                float rr = ZTabLayout.mTabStrip.getChildAt(position + 1).getRight()
//                        - scale * ZTabLayout.mTabStrip.getChildAt(position + 1).getWidth();
//                ZTabLayout.mTabStrip.right = lr + (positionOffset / 0.5f) * (rr - lr);
//                ViewCompat.postInvalidateOnAnimation(ZTabLayout.mTabStrip);
//            }
//            // 左滑（右侧页面进入）的第二阶段
//            // 以及右滑（左侧页面进入）的第一阶段
...
//                        - scale * ZTabLayout.mTabStrip.getChildAt(position + 1).getWidth();
//                // 先确保 Indicator 滑动最右
//                if (ZTabLayout.mTabStrip.right < rr) {
//                    ZTabLayout.mTabStrip.right = rr;
//                    ViewCompat.postInvalidateOnAnimation(ZTabLayout.mTabStrip);
//                }
//                float ll = ZTabLayout.mTabStrip.getChildAt(position).getLeft()
//                        + scale * ZTabLayout.mTabStrip.getChildAt(position).getWidth();
//                float rl = ZTabLayout.mTabStrip.getChildAt(position + 1).getLeft()
//                        + scale * ZTabLayout.mTabStrip.getChildAt(position + 1).getWidth();
//                ZTabLayout.mTabStrip.left = ll + ((positionOffset - 0.5f) / 0.5f) * (rl - ll);
//                ViewCompat.postInvalidateOnAnimation(ZTabLayout.mTabStrip);
//            }
//            // 滑动开始或结束
//            if (positionOffset == 0) {
//                ZTabLayout.mTabStrip.left = ZTabLayout.mTabStrip.getChildAt(position).getLeft()
//                        + scale * ZTabLayout.mTabStrip.getChildAt(position).getWidth();
//                ZTabLayout.mTabStrip.right = ZTabLayout.mTabStrip.getChildAt(position).getRight()
//                        - scale * ZTabLayout.mTabStrip.getChildAt(position).getWidth();
//                ViewCompat.postInvalidateOnAnimation(ZTabLayout.mTabStrip);
//            }
//
...
//                    ", positionOffsetPixels = " + positionOffsetPixels);
        ...
        public void onPageSelected(final int position) {
            final ZTabLayout ZTabLayout = mTabLayoutRef.get();
            if (ZTabLayout != null && ZTabLayout.getSelectedTabPosition() != position
                    && position < ZTabLayout.getTabCount()) {
                // Select the tab, only updating the indicator if we're not being dragged/settled
                // (since onPageScrolled will handle that).
                final boolean updateIndicator = mScrollState == SCROLL_STATE_IDLE
                        || (mScrollState == SCROLL_STATE_SETTLING
                        && mPreviousScrollState == SCROLL_STATE_IDLE);
                ZTabLayout.selectTab(ZTabLayout.getTabAt(position), updateIndicator);
            }
        }
