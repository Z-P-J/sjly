...
abstract public class GroupRecyclerViewAdapter<T> extends RecyclerView.Adapter<GroupViewHolder> {
    ...
    public void onBindViewHolder(final GroupViewHolder holder, int position) {
        ...
        final int childPosition = getGroupChildPosition(groupPosition, position);
        final T item = getItem(groupPosition, childPosition);
        ...
        if (null != onItemClickListener) {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (null != onItemClickListener) {
                        onItemClickListener.onItemClick(GroupRecyclerViewAdapter.this, holder, item, groupPosition, childPosition);
                    }
                }
            });
        }
        ...
        if (null != onItemLongClickListener) {
            holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (null != onItemLongClickListener) {
                        onItemLongClickListener.onItemLongClick(GroupRecyclerViewAdapter.this, holder, item, groupPosition, childPosition);
                        return true;
                    }
                    return false;
                }
