...
public final class ConstrainableInputStream extends BufferedInputStream {
    ...
    private ConstrainableInputStream(InputStream in, int bufferSize, int maxSize, long timeoutMillis) {
        super(in, bufferSize);
     ...
     */
    public static ConstrainableInputStream wrap(InputStream in, int bufferSize, int maxSize, long timeoutMillis) {
        return in instanceof ConstrainableInputStream
            ? (ConstrainableInputStream) in
            : new ConstrainableInputStream(in, bufferSize, maxSize, timeoutMillis);
    }
