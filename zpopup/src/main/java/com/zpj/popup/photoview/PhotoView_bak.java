...
public class PhotoView_bak extends AppCompatImageView {

    public PhotoViewAttacher attacher;
    private ScaleType pendingScaleType;

    public PhotoView_bak(Context context) {
        this(context, null);
    }

    public PhotoView_bak(Context context, AttributeSet attr) {
        this(context, attr, 0);
    }

    public PhotoView_bak(Context context, AttributeSet attr, int defStyle) {
