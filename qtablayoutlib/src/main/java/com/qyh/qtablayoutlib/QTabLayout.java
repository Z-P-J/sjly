...
//            Log.d("IndicatorPosition2Left", "left=" + left);
//            Log.d("IndicatorPosition2Left", "right=" + right);
...
//                            + (1.0f - mSelectionOffset) * (left + (nextTitle.getWidth() - mSelectedIndicatorWidth) / 2));
                    right = (int) (mSelectionOffset * (nextTitle.getLeft() + (nextTitle.getWidth() - mSelectedIndicatorWidth) / 2)
                            + (1.0f - mSelectionOffset) * left);
...
//            Log.d("IndicatorPosition2Right", "left=" + left);
//            Log.d("IndicatorPosition2Right", "right=" + right);
            setIndicatorPosition(left, right);
        }
...
//                }
    ...
    public static class ViewPagerOnTabSelectedListener implements QTabLayout.OnTabSelectedListener {
        ...
        @Override
        public void onTabs(List<Tab> tabs) {
